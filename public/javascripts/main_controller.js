...
mainApp.controller('BrowseController', function($scope, $routeParams, $location) {
  ...
  $scope.groupName = "Men";
  $scope.searchCriteria = "Location: " + searchCrit.location + "|Radius: " + searchCrit.radius;
  $scope.profiles = filteredProfiles;//getProfiles($routeParams.searchParams);
});

mainApp.controller('SearchController', function($scope, $routeParams, $location) {
  $scope.master = {};
  $scope.search = {};
  $scope.fileLocation = $location;
  // $scope.$location = $location;
  ...
  $scope.search = function() {
    //searchProfiles($scope.search.gender);
